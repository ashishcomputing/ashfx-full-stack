...
export const liveDebateMessages: AgentDebateMessage[] = [
  ...
  },
  {
    ...
    confidence: 93,
    timestamp: '11:35:32',
    rationale: 'Retail positioning on Gold currently sits at 76% short across top broker feeds. Liquidation cluster above 2,648.00 represents $142M in short stop-loss orders. Market makers have massive liquidity incentive to squeeze shorts higher.',
    metrics: [
      { label: 'Retail Ratio', value: '76% Short / 24% Long' },
      { label: 'Short Liquidations', value: '$142.4M at 2648.0' },
  ...
  },
  {
    ...
    confidence: 95,
    timestamp: '11:36:01',
    rationale: 'Confirmed clean liquidity sweep of Asian session low (2624.10) followed by 5M/15M Market Structure Shift. Clear Fair Value Gap imbalance printed between 2636.20 - 2638.50 with heavy positive delta (+4,200 contracts). Conflux score 96/100.',
    metrics: [
  ...
  },
  {
    ...
    confidence: 84,
    timestamp: '11:36:45',
    rationale: 'Adversarial check: 1) London fixing at 15:00 UTC could cause brief 8-point whipsaw. 2) Correlation between XAU and US30 is temporarily elevated (0.82). If we execute, max risk must not exceed 1.0% equity ($1,250) and stop loss must strictly remain below 2628.00 sweep low.',
    metrics: [
  ...
  },
  {
    ...
    confidence: 92,
    timestamp: '11:37:12',
    rationale: 'CONSENSUS REACHED: 4-to-1 Strong Bullish alignment. Macro tailwind confirmed, retail liquidity squeeze ripe, institutional order flow validated. Adversarial risk constraints incorporated: Recommended position size adjusted to 2.0 Lots with 2628.00 Stop Loss and 2665.00 Take Profit (1:3.4 R:R). Routing to MT5 Bridge.',
    metrics: [
